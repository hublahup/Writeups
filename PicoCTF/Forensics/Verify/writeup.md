...
2.	Anda dapat membuat checksum SHA dari sebuah file dengan menggunakan $ echo sha256sum <file> atau dari semua file di dalam sebuah direktori dengan menggunakan sha256sum <directory>/*.
